...
file.remove( "results/report.html", "results/Template.R" )
...
if(is.null(params$Data1)==FALSE){
  ...
  if(is.null(params$DS1)== FALSE){ocean_variables(sps=sps,data_type=params$Data1,parameter = params$DS1)}
 }
```
...
```{r,echo=FALSE,results='asis'}
  ...
  if(is.null(params$Data3)==FALSE){
    if(is.null(params$DS1)== TRUE){HTML(paste(""))}
...
```{r,echo=FALSE,warning=FALSE,message=FALSE, fig.height = 10, fig.width = 10}
  ...
  if(is.null(params$Data7)==FALSE){
    ...
    else if(params$DS7!="NA"){ocean_variables(sps=sps,data_type=params$Data7)}
   }
```
...
```{r,echo=FALSE,warning=FALSE,message=FALSE, fig.height = 10, fig.width = 10}
  ...
  if(is.null(params$Data8)==FALSE){
    ...
    else if(params$DS8!="NA"){ocean_variables(sps=sps,data_type=params$Data8)}
   }
```
