...
zooplankton_variables<-function(season,Year,species,max_rel_error,time_bin){
  ...
  x[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_one_year.grd")
   x1[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_L1_one_year.grd")
   x2[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_L2_one_year.grd")
   xx[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_ten_years.grd")
   xx1[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_L1_ten_years.grd")
   xx2[[i]]<-paste0("data/zooplankton/",sp[i],"/Ab_L2_ten_years.grd")
  }
